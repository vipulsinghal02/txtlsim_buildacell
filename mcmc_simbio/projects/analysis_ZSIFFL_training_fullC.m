...
projdir = [pwd '/mcmc_simbio/projects/proj_ZSIFFL_trainingC'];
addpath(projdir)
...
mcmc_info = mcmc_info_ZSIFFL_training_fullC(mtet, mlac, mlas);
di = data_ZSIFFL;
...
switch tsIDtouse
    case 1 % this is after including the termination parameters. 
        ts1 = '20190509_092707_1_1476';
        ts2 = '20190509_160552_1_1476';
        ts3 = '20190509_160552_2_738';
        ts4 = '20190509_160552_3_554';
        ts5 = '20190510_064333_1_369';
        ts6 = '20190510_064333_2_185';
        ts7 = '20190510_064333_3_74';
        ts8 = '20190511_014023_1_74';
        tstamp = {ts1 ts2 ts3 ts4 ts5 ts6 ts7 ts8};
        nIterID = {1:8 1:20 1:20 1:20 1:20 1:20 1:8 1:5};
