...
projdir = [pwd '/mcmc_simbio/projects/proj_ZSIFFL_trainingD'];
addpath(projdir)
...
mcmc_info = mcmc_info_ZSIFFL_training_fullD(mtet, mlac, mlas);
di = data_ZSIFFL;
...
switch tsIDtouse
    case 1 % this is after including the termination parameters. 
        ts1 = '20190511_062400_1_738';
        ts2 = '20190511_131947_1_369';
        ts3 = '20190511_131947_2_74'
        tstamp = {ts1 ts2 ts3};
        nIterID = {1:11 1:20 1};
