%% Tutorial IIx--The Incoherent Feedforward loop
% In this tutorial, we build the incoherent feedforward loop, and discuss 
% the various components of the model in detail. We recommend you read through the
% <https://vipulsinghal02.github.io/txtlsim_buildacell/tutorial.html
% first> tutorial before starting on this one. 
%
% Vipul Singhal, Mar 2018
