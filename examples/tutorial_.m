%% Tutorial ...
% tutorial_iii.m - Understanding component code files, and parameter config files. 
% 
% In this tutorial, we describe the component code files, and the parameter
% configuration files. This should allow you to create new component files
% and add them to the toolbox if needed. 
% 
% 
