...
dna_deGFP = txtl_add_dna(tube3,  'plasR_ptet(50)', 'rbs(20)', 'deGFP(1000)', GFP,'plasmid');
...
for i = 1:n
    ...
    hold on
        ...
        title('GFP levels, placI-lasR = 1nM, plasR-tetR = 0.0015 nM, 3OC12HSL = 10uM, plasRptet-GFP varying')  
        legend(h, {' 0.25 nM','0.5 nM','1 nM','2 nM','4 nM', '8 nM'}, 'Location', 'NorthEastOutside')
xlabel('time, min')
ylabel('GFP, nM')
